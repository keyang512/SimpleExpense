...
- Create Angular project with ng: `ng new simpleexpensemanagement.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`simpleexpensemanagement.client.esproj`).
